...
class ThisOrThatTestCase(unittest.TestCase):
    ...
    def test_get_update_entry(self):
        result = self.client().get('/api/entries/1/update', headers={'Authorization': 'Bearer ' + user_jwt})
        data = json.loads(result.data)
    ...
    def test_patch_update_entry(self):
        ...
        result = self.client().patch('/api/entries/46/update', json=patch_entry, headers={'Authorization': 'Bearer ' + user_jwt})
        data = json.loads(result.data)
    ...
    def test_404_failed_no_update_entry(self):
        ...
        #User level auth
        result = self.client().patch('/api/entries/100000/update', json=patch_entry, headers={'Authorization': 'Bearer ' + user_jwt})
        data = json.loads(result.data)
    ...
    def test_400_failed_update_entry(self):
        #update API endpoint ID to match your database
        result = self.client().patch('/api/entries/49/update', data=dict(name='test no category', category=''), headers={'Authorization': 'Bearer ' + user_jwt})
        data = result.get_json()
    ...
    def test_delete_entry(self):
        #update API endpoint ID to match your database
        #Admin level auth
        result = self.client().delete('/api/entries/51/delete', headers={'Authorization': 'Bearer ' + admin_jwt})
        data = json.loads(result.data)
    ...
    def test_401_not_auth_delete_entry(self):
        ...
        result = self.client().delete('/api/entries/51/delete', headers={'Authorization': 'Bearer ' + user_jwt})
        data = json.loads(result.data)
    ...
    def test_404_failed_delete_no_entry(self):
        result = self.client().delete('/api/entries/100000/delete', headers={'Authorization': 'Bearer ' + admin_jwt})
        data = json.loads(result.data)
